            ...
            child: BlocBuilder<EmployeeListCubit, EmployeeListState>(
              builder: (context, state) {
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () => context.read<EmployeeListCubit>().refresh(),
                ...
                if (employees.isEmpty) {
                  return const Center(
                    child: Text('لا يوجد موظفون', style: TextStyle(color: AppColors.textMuted)),
                  );
                }
                      ...
                      return Card(
                        child: ListTile(
                          leading: CircleAvatar(
                            ...
                            child: Text(e.code, style: const TextStyle(fontSize: 11, color: AppColors.gold)),
                          ),
                          title: Text(e.fullName, style: const TextStyle(fontWeight: FontWeight.w600)),
                          subtitle: Text(e.jobTitle, style: const TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                          trailing: const Icon(Icons.chevron_left, color: AppColors.textMuted),
                          onTap: () => Navigator.of(context).push(
                            MaterialPageRoute(builder: (_) => EmployeeDetailsPage(employeeId: e.id)),
                          ),
                        ),
                      );
                    },
